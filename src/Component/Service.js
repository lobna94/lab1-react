...
//    ]
    ...
    render(){
        return(
        //    <ul>
        //        {this.state.services.map(svg=><li className="text-white">{this.text}</li>)}
               
        //    </ul>
      
  <div className="container mt-10">
  <div  className="row row-cols-4 mt-10">
    <div  className="col text-white ">
       ...
       <h3> Access your files,</h3> anywhere The ability to use a smaphane, tablet, or computer to acces your account means your files folow you everywhere.
        </div>
    <div  className="col text-white">
        ...
        <h3>Security you can trust </h3>2Mactor authencation and uner controlied encrytion Just a coupie of the securay features we al secure your fies Real-time collaboration Store any type of file 
        </div>
    <div  className="col text-white">
       ...
       <h3> Real-time collaboration</h3> Store any type of file Securely share fies and folders with frends famity and colleagus for e collaboraion. 
        </div>
    <div  className="col text-white">
        ...
        <h3>Store any type of file Securely</h3> share fies and folders with frends famity and colleagus for e collaboraion
        </div>
  </div>
</div>
        )
